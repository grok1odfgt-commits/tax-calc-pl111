...
<style>
    ...
    section[data-testid="stSidebar"] > div:first-child {
        padding-top: 0px;                                 /* основний контейнер вмісту (разом з кнопкою "згорнути меню" отримує верхній відступ, щоб інші елементи (кнопки, файли) не наїжджали на заголовок */
    }
    section[data-testid="stSidebar"] h1 {
        position: absolute;                                /* Абсолютне позиціонування */
        top: -50;                                          /* Притискаємо заголовок до верху сайдбару */
        left: 0;                                           /* Відступ напису зліва (можна змінити) */
        margin: 0;
        padding: 0;
        z-index: 10;                                       /* Щоб був поверх кнопки */
        font-size: 1.2rem;                                 /* Розмір шрифта заголовка */
    }
    
    section[data-testid="stSidebar"] hr {                 /* Піднімаємо горизонтальну лінію вгору, зменшуючи відстань до заголовка */
        margin-top: -8px;                                 /* Регулюйте це значення, щоб горизонтальна розділова лінія була ближче до заголовка */
    }
</style>
