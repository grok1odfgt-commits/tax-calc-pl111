...
<style>
    ...
    section[data-testid="stSidebar"] > div:first-child {
        padding-top: 0px;                                 /* основний контейнер вмісту отримує верхній відступ, щоб інші елементи (кнопки, файли) не наїжджали на заголовок */
    }
    section[data-testid="stSidebar"] h1 {
        position: absolute;                                /* Абсолютне позиціонування */
        top: -50;                                            /* Притискаємо заголовок до верху сайдбару */
        left: 0;                                           /* Відступ зліва (можна змінити, щоб не перекривати кнопку) */
        margin: 0;
        padding: 0;
    ...
    section[data-testid="stSidebar"] hr {
        margin-top: -10px;                                 /* Регулюйте це значення, щоб горизонтальна розділова лінія була ближче до заголовка */
    }
</style>
