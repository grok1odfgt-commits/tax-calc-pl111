...
<style>
    ...
    section[data-testid="stSidebar"] h1 {
        ...
        top: 0;                                          /* Відступ заголовку від верху сайдбару */
        left: 20px;                                        /* Відступ звголовку зліва (можна змінити, щоб не перекривати кнопку) */
        margin: 0;
        padding: 0;
        z-index: 10;                                       /* Щоб був поверх кнопки */
        font-size: 1.0rem;                                 /* За бажанням, можна змінити розмір */
    }
</style>
